export function SuccessVueNotification({ dismiss }) {
  return (
    <div className="border-l-4 border-green-400 bg-green-50 p-4 text-sm flex items-center shadow-lg">
...
export function InfoVueNotification({ dismiss }) {
  return (
    <div className="border-l-4 border-blue-400 bg-blue-50 p-4 text-sm flex items-center shadow-lg">
...
export function WarningVueNotification({ dismiss }) {
  return (
    <div className="border-l-4 border-yellow-400 bg-yellow-50 p-4 text-sm flex items-center shadow-lg">
...
export function DangerVueNotification({ dismiss }) {
  return (
    <div className="border-l-4 border-red-400 bg-red-50 p-4 text-sm flex items-center shadow-lg">
