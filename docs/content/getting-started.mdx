...
Choose one theme and copy/paste it in your project!

<Customization selectedTheme={props.selectedTheme} onChange={props.onChange} />
<Theme name={props.selectedTheme} />
